...
def get_alignment(path='C:/Users/Jakob Seidl/Desktop/capture/alignment.csv', origin = (0,0), v2 = 1 , getslope=True):
    ...
    t = alignment.get_trans((x1, y1), origin)
    r = alignment.get_angle((x1, y1), (x2, y2))
    zoom = alignment.get_zoom((x1, y1), (x2, y2), v2)
    base = z1
...
if __name__ == '__main__':
    #position()
    #print(read_all())
    #params = get_alignment(v2 = 2.3, getslope=True)
